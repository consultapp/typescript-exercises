...
exports.nameDecorators = [str_utils_1.strReverse, str_utils_1.strToLower, str_utils_1.strToUpper, str_utils_1.strRandomize, str_utils_1.strInvertCase];
...
[].concat(users, admins).forEach(logPerson);
